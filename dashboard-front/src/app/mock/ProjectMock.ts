...
export class ProjectMock {
    ...
    static getData() : Project[] {
        return [
            ...
            new Project(2, 'Spring', 'Establishing a POC of angular concept applyed to a realworld project for a realworld deploy', [], [{id: 2525, label: 'first sprint !', description: 'Il faut tout finir !!!', tickets: [{id: 100, label: 'impl authentication', description: null, estimatedTime: 6}, {id: 101, label: 'impl bean validation', description: null, estimatedTime: 16}]}], [], []),
